...
- (void)updateToolbarWithOriginal:(BOOL)isOriginal
    ...
    //发送按钮
    NSString *rightBtnName = @"使用照片";//使用照片，livesxu
    self.sendBtn = [[UIBarButtonItem alloc] initWithTitle:[NSString stringWithFormat:@"%@",rightBtnName] style:UIBarButtonItemStyleBordered target:self action:@selector(sendAction)];
    ...
    self.sendBtn.enabled =YES;//livesxu
