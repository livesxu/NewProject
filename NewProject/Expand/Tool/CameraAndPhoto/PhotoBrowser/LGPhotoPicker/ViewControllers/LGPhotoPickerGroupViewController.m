...
- (UITableView *)tableView{
    if (!_tableView) {
        ...
        self.tableView.tableFooterView = [[UIView alloc] initWithFrame:CGRectZero];//取消多余的分割线，livesxu
    }
    return _tableView;
}
...
- (void)viewDidLoad {
    ...
    //ALAssetsLibrary 获取所有图片 http://www.cnblogs.com/liangxing/archive/2013/01/05/2846136.html ,livesxu
...
#pragma mark - 创建右边取消按钮，改cancel为退出
