...
- (void)longPress:(UILongPressGestureRecognizer *)longPress{
    ...
    if (longPress.state == UIGestureRecognizerStateBegan) {
        ...
        //回调
        ctrl.completionWithItemsHandler = ^(UIActivityType __nullable activityType, BOOL completed, NSArray * __nullable returnedItems, NSError * __nullable activityError) {
